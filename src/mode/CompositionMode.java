...
public class CompositionMode extends Linemode{
	...
	public void mouseReleased(MouseEvent e) {
		...
		if(click_inside == true && press_inside == true) {
			Panel.getInstance().lines.add(new AssociationLine(drawx1,drawy1,drawx2,drawy2,3,Panel.getInstance().shapes.get(which_shape).getid(),which_port,Panel.getInstance().shapes.get(which_shape2).getid(),which_port2));
